...
namespace Microsoft.Boogie {
  ...
  public class VerifierCallback {
    ...
    // other reason means it's time out/memory out/crash
     ...
     public virtual void OnCounterexample(Counterexample ce, IList<string/*!*/>/*!*/ labels, IList<Block> blocks,string/*?*/ reason)
     {
         Contract.Requires(ce != null);
     }


    public virtual void ExtendCounterexample(Counterexample ce, IList<VCExpr> frees, List<string> freeVar)
    {
        Contract.Requires(frees != null);
    }

    public virtual string SetCurrentCounterexamplePathExpr(Counterexample ce)
    {
        return "";
    }
    //public virtual List<VCExpr> OnExtendCounterexample(Counterexample ce)
    //{
    //    //Contract.Requires(ce != null);
    ...
    public virtual IList<VCExpr> GetCounterexampleState(Counterexample ce)
    {
        return null;
    }
