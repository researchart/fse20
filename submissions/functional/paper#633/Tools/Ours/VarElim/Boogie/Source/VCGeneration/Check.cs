...
namespace Microsoft.Boogie {
  ...
  public abstract class ProverInterface {
    ...
    public class ErrorHandler {
      ...
      public virtual void StartExtendCounterexample(Counterexample ce, IList<VCExpr> frees)
      {
          return;
      }
    ...
    public virtual Tuple<int, int> ExtendedCounterexamples(ErrorHandler handler, VCExpr env, int bound, int taskID = -1)
    {
        throw new NotImplementedException();
    }
    // (push 1)
