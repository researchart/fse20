...
exper = Experiment(
    ...
    boogiePath='D:/CodeRepository/PInferLoopInv/Tools/Ours/Dig/Boogie/Binaries/Boogie.exe',
...
exper.GenXlsxFromDict('D:/CodeRepository/PInferLoopInv/PInferLoopInvExperiments/Results',result,infoExtra='Dig',titleAdd='Dig')
