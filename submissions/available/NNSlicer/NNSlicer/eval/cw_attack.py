...
# from trace import lenet_mnist_class_trace
from tf_utils import new_session_config, restore_scope
...
from .cw_attacks import CarliniL0, CarliniL2, CarliniLi, CWAttack
