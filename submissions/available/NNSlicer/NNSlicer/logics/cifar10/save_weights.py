...
result_dir = f"{model_dir}/nninst_mu_posneg/posneg_edge_{threshold}"
...
# result_dir = f"{model_dir}/nninst_mu_posneg/posonly_edge_0.5"
...
def compute_logics(
    ...
    def save_training_logics(
        ...
        original_masks = reconstruct_weight_fn(
            original_trace,
            valid_names,
        )
    ...
    def save_test_logics(
        ...
        adversarial_masks = reconstruct_weight_fn(
            adversarial_trace,
            valid_names,
        )
