...
exper = Experiment(
    ...
    boogiePath='D:/CodeRepository/PInferLoopInv/Tools/Ours/Boundary/Boogie/Binaries/Boogie.exe',
...
exper.GenXlsxFromDict('D:/CodeRepository/PInferLoopInv/PInferLoopInvExperiments/Results',result,infoExtra='Boundary',titleAdd='Boundary')
