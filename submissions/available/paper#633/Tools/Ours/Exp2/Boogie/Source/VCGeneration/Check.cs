...
namespace Microsoft.Boogie {
  ...
  public abstract class ProverInterface {
    ...
    public class ErrorHandler {
      ...
      public virtual IList<VCExpr> ExtendCex(Counterexample ce)
      {
          return new List<VCExpr>();
      }

      public virtual IEnumerable<Counterexample> GetAllCounterexamples()
      {
          List<Counterexample> res = new List<Counterexample>();
          return res;
      } 
      public virtual void StartExtendCounterexample(Counterexample ce, IList<VCExpr> restr, List<string> freeVar)
      {
          return;
      }

      public virtual string SetCounterexamplePathVCMacro(Counterexample ce)
      {
          return "";
      }

      public virtual IList<Block> GetCounterExampleBlocks(Counterexample ce)
      {
          return null;
      }

      public virtual IList<string> GetCounterexampleLabels(Counterexample ce){
          return null;
      }
    ...
    public virtual Outcome ExtendedCheckOutcomeCore(ErrorHandler handler, VCExpr env, out bool allFree, int bound, int taskID = -1) {
        throw new NotImplementedException();
    }

    public virtual bool ExtendedCounterexample(ErrorHandler handler, Counterexample e, VCExpr env, int taskID = -1) {
        throw new NotImplementedException();
    }

    public virtual Tuple<int, int> ExtendedCounterexamples(ErrorHandler handler, VCExpr env, int bound, Dictionary<Counterexample,Boolean> IsImpl, int taskID = -1)
    {
        throw new NotImplementedException();
    }
    // (push 1)
