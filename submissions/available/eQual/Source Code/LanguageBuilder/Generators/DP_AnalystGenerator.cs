...
{
    public class DP_AnalystGenerator : DP_IGenerator
    {
        ...
        protected void Generate(DP_Metamodel metamodel)
        {
            ...
            modelWriter.WriteLine("using DomainPro.Analyst.Types;");
            ...
            structureWriter.WriteLine("using DomainPro.Analyst.Types;");
