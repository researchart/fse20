...
{
    public class DP_MetaInheritance : DP_Line
    {
        ...
        protected override void SetParams()
        {
            ...
            LineProperties.Role1.Icon = "Graphics\\emptytriangle.gif";
        ...
        public DP_MetaInheritance()
        {
        }

        public DP_MetaInheritance(DomainProDesigner.DP_ConnectionSpec newRole1, DomainProDesigner.DP_ConnectionSpec newRole2) :
            base(newRole1, newRole2)
        {
            Diagram = new DP_MetaInheritanceDiagram();
            Text = new DP_Text();
        }
        ...
        {
            DP_MetaInheritance newType = new DP_MetaInheritance();
            newType.Diagram = new DP_MetaInheritanceDiagram();
