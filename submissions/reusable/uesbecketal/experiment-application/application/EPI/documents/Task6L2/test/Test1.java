...
public class Test1{
	...
	private Table altQuery5(Table student, Table clubmap) throws Exception {
		RequestBuilder q = new RequestBuilder();

		q.setCombineKey(student, "id");
		q.setCombineKey(clubmap, "studentid");
		q.combine(student, clubmap);
		q.requestFields("id, firstname, lastname, clubname");
