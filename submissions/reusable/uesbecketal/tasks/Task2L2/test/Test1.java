...
public class Test1 {
	...
	public void test() throws Exception {
		...
		Table query = new Task2().query(student);

		if (query == null) {
			System.out.println("Null returned instead of table object");
		}
		
		Table result = altQuery1(student);
		query.outputTable();
	...
	private Table altQuery1(Table student) throws Exception {
		...
		q.Prepare("SELECT id, year, grade FROM students WHERE lastname = 'Schmidt' and grade != 'F'");
