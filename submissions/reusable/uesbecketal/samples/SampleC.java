...
public class SampleC {
	...
	public void sample(Table cars, Table ticketlist) throws Exception {
		...
		insertCarsQuery.AddValue("id", 2345);
		insertCarsQuery.AddValue("make", "Toyota");
		insertCarsQuery.AddValue("model", "Verso");
		insertCarsQuery.AddValue("year", 2016);
		insertCarsQuery.AddValue("licenseplatenumber", "326 NEB");
		insertCarsQuery.AddValue("registrationyear", 2017);
		...
		*/
		...
		carsNotMercedesQuery.AddField("make");
		carsNotMercedesQuery.AddField("model");
		carsNotMercedesQuery.AddField("year");
		
		carsNotMercedesQuery.Filter(carsNotMercedesQuery.Where("make").NotEquals("Mercedes"));
		...
		carTicketQuery.AddField("id");
		carTicketQuery.AddField("make");
		carTicketQuery.AddField("model");
		carTicketQuery.AddField("description");
		...
		carsOlderQuery.AddField("make");
		carsOlderQuery.AddField("model");
		carsOlderQuery.AddField("year");
		carsOlderQuery.AddField("licenseplatenumber");
		carsOlderQuery.AddField("registrationyear");
		
		carsOlderQuery.Filter(carsOlderQuery.Where("year").LessThan(2015));
		...
		updateQuery.Filter(updateQuery.Where("make").Equals("Mercedes").Or("model").Equals("CS250"));
